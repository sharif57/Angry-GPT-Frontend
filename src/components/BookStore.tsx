...
//             <div
//               key={book.id}
//               className="bg-card rounded-[20px] p-4 transition-all hover:shadow-lg hover:translate-y-[-4px] dark:bg-white duration-300 border border-border/40"
//             >
//               {/* Book Image */}
...
//                 <h3 className="font-medium text-[24px] line-clamp-2 text-[#4D4D4D] dark:text-[#4D4D4D]">
//                   {book.title}
//                 </h3>
//                 <div className="flex items-center justify-between">
//                   <div className="flex items-center gap-1">
//                     <h1 className="text-black text-[20px]">$</h1>
//                     <span className="text-[32px] font-semibold dark:text-black">
//                       {book.price}
//                     </span>
//                   </div>
//                   <Button
//                     size="lg"
//                     className="rounded-full bg-[#CAEA31] hover:bg-[#CAEA31] text-[#1E1E1E] font-medium px-4 transition-colors"
//                   >
//                     Buy Now
//                   </Button>
//                 </div>
...
//           <Button
//             variant="outline"
//             className="rounded-full px-8 py-2 border-[#000000] dark:border-lime-800 hover:bg-lime-100 dark:hover:bg-lime-900/30 transition-colors"
//           >
//             See All
//           </Button>
    ...
    <section className="py-8 sm:py-12 md:py-16 lg:py-24">
      <div className="w-full max-w-[1240px] mx-auto px-4 sm:px-6">
        ...
        <div className="flex justify-end mb-8 sm:mb-12">
          <Button
            variant="outline"
            className="rounded-full px-6 sm:px-8 py-1.5 sm:py-2 border-[#000000] dark:border-[#CAEA31] hover:bg-lime-100 dark:hover:bg-lime-100 text-black dark:text-white transition-colors"
          >
            See All
          </Button>
        </div>
