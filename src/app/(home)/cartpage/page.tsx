...
//                   <Image
//                     src={`${IMAGE}${item.images[0]}` || "/placeholder.svg"}
//                     alt={item.title}
//                     width={80}
//                     height={100}
...
//                     <Image
//                       src={`${IMAGE}${item.images}` || "/placeholder.svg"}
//                       alt={item.title}
//                       width={100}
//                       height={120}
//                       className="object-contain"
...
export default function CartPage() {
  ...
  const removeItem = async (id: string) => {
    try {
      const response = await removeFromCart(id).unwrap();
                  ...
                  <div className="flex flex-col justify-between flex-grow">
                    ...
                    <div className="flex justify-between items-center mt-2">
                      ...
                      <Button
                        variant="ghost"
                        size="sm"
                        className="text-gray-500 hover:text-red-500 p-1 h-auto cursor-pointer"
