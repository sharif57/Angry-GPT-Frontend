...
//           {/* Header */}
//           <h1 className="text-[30px] font-medium text-black dark:text-white  pb-8">Explore More</h1>
//           {/* Book Grid */}
...
import { useState } from "react";
import Image from "next/image";
import { Lock, Mail, MinusIcon, PlusIcon } from "lucide-react";
import { Button } from "@/components/ui/button";
import Link from "next/link";
        ...
        <DialogContent className="sm:w-[488px] p-0 overflow-hidden lg:px-[40px] lg:py-[80px] bg-[#1E1E1E] dark:bg-[#1E1E1E] text-white border-none">
          <div className="relative flex flex-col items-center p-6">
            ...
            <div className="flex items-center mb-6">
              ...
              <span className="text-xl font-bold">AngryGPT</span> */}
